    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div className="w-2/5 rounded-md border bg-white p-3">
          <h1 className="text-base font-medium text-opacity-70">{title}</h1>
          <div className="flex w-full flex-col items-center justify-center">
            <div className="flex w-full items-center justify-between">
              <div className="text-base font-medium text-opacity-70">
                Other Images
              </div>
              <div className="flex h-10 items-center justify-center rounded-md border border-gray-400 px-2 hover:bg-gray-200">
                <Link
                  to={`./?id=${id}&edit=true&otherimages=true`}
