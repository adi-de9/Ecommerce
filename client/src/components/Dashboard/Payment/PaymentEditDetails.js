...
function PaymentEditDetails({ id, edit }) {
  ...
  const [userData, setPaymentData] = useState({
    name: '',
    username: '',
    email: '',
    role: '',
  ...
  useEffect(() => {
    if (singlePayment) {
      setPaymentData({
        name: singlePayment.name,
        username: singlePayment.username,
        email: singlePayment.email,
        role: singlePayment.role,
        newPassword: '',
        password: '',
        avatar: singlePayment.avatar,
      });
    }
  }, [singlePayment]);
  ...
  const handleFormSubmit = (e) => {
    ...
    if (id != 'new' && edit == 'true') {
      dispatch(updatePayment({ id, userData }));
      if (avatarData) {
          ...
          <div className="flex w-full flex-col">
            ...
            {!userData?.avatar && !avatarData ? (
              <input
                ...
                id="image"
                name="image"
                placeholder="Payment Main Image"
...
export default PaymentEditDetails;
